    ...
    <>
      <div ref={heroRef} className='relative overflow-hidden z-0'>
        ...
        <div className="main-container h-screen flex flex-col lg:justify-center items-start lg:py-12 max-lg:pt-40">
          <h1 className="text-2xl sm:text-3xl lg:text-[3.2vw] uppercase font-heading font-semibold">Khizer Abbas</h1>
          <h2 className="text-5xl sm:text-6xl lg:text-[8vw] font-heading font-bold leading-[1] tracking-tight mt-3 mb-6">Web App <br/>  <span className='text-stroke'> Developer </span></h2>
          <GradientButton text="Let's Talk" link="https://wa.me/923376333235" className="gradient-btn" />
        </div>
